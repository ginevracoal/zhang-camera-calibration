...
1. apply the code as it is for calibration;
	- look here for camera calibration using OpenCV: https://docs.opencv.org/2.4/modules/calib3d/doc/camera_calibration_and_3d_reconstruction.html
2. choose one of the calibration images and compute the total reprojection
error (Lecture 2, page 62) for all the grid points (adding a figure with the
reprojected points);
